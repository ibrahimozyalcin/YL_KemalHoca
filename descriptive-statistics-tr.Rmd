...
author: "H. Kemal İLTER'e ait dosya düzenlemesi. Düzenleyen İbrahim ÖZYALÇIN"
date: "27.10.2021"
output: 
    html_document:
    css: styles.css
...
```{r}
plot(veri$height[1:3000],ylim=c(3,7))
...
set.seed(1234)
df <- data.frame(
  boy=round(rnorm(1000, mean=110, sd=15))
  )
summary(df)
ggplot(df, aes(x=boy)) + geom_histogram(binwidth=10)
```
